...
/* package haskell-advent-0.1.0.0 */
#ifndef VERSION_haskell_advent
#define VERSION_haskell_advent "0.1.0.0"
#endif /* VERSION_haskell_advent */
#ifndef MIN_VERSION_haskell_advent
#define MIN_VERSION_haskell_advent(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_advent */
...
#define CURRENT_COMPONENT_ID "haskell-advent-0.1.0.0-inplace-haskell-advent"
